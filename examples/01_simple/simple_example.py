...
aKWK  = CHPunit('CHP_unit', eta_th = 0.5, eta_el = 0.4,  # name, thermal efficiency, electric efficiency
                # defining flows:
...
aSpeicher = Storage('Speicher',
                    ...
                    investArgs=InvestmentParameters(fixCosts=20,
...
es = EnergySystem(aTimeSeries, dt_last=None) # creating system, (duration of last timestep is like the one before)
...
aCalc = EnergySystemCalculation('Sim1',  # name of calculation
...
print('way 3:')
print(aBoiler.Q_th.vars_and_eqs.var_val.getResult()) # access directly through component/flow-variables
