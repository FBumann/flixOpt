...
aKWK  = CHPunit('BHKW2', eta_th = 0.58, eta_el=0.22, switchOnCosts =  24000,
...
p_feed_in = TimeSeriesData(-(p_el - 0.5), agg_type='p_el') # weight shared in group p_el
p_sell    = TimeSeriesData(p_el + 0.5, agg_type='p_el')
...
if calcAgg is not None:
  ...
  for var in aggretation_ME.vars_and_eqs.variables:
